...
public class DateUtilTest {
    ...
    /**
     * Method: difference(Date one, Date two, DatePattern pattern)
     */
    @Test
    public void testDifference() {
        Date date1 = new Date(111111111110000L);
        Date date2 = new Date(111111111111111L);
        DatePattern datePattern = DatePattern.SECOND;
        int difference = DateUtil.difference(date1, date2, datePattern);

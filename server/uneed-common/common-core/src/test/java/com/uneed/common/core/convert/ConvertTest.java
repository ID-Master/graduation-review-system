package com.uneed.common.core.convert;

import com.uneed.common.core.entity.TestEnum;
...
public class ConvertTest {
    ...
    public void testToEnumForClazzValue() {
        ...
        expectedEx.expectMessage("No enum constant com.uneed.common.core.entity.TestEnum.1000");
        Integer integer = 1000;
        assertNull(Convert.convert(TestEnum.class, integer));
    }
    ...
    public void testToListForElementTypeValue() {
        ...
        List<User> list = Convert.toList(User.class, users);
        assertEquals("[User(name=null, age=18, studentId=null), User(name=null, age=19, studentId=null), User(name=null, age=20, studentId=null)]", list
                .toString());
    }

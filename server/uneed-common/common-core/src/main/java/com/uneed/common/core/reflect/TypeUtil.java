...
public class TypeUtil {
     ...
     * 基本类型：void，int，float等java基本类型，其实也是class
     *
    ...
    public static Type getType(Field field) {
        return isNull(field) ? null : ObjectUtil.nullToDefault(field.getGenericType(), field.getType());
    }
    ...
    public static Class<?> getClass(Field field) {
        return isNull(field) ? null : field.getType();
    }
    ...
    public static Type getParamType(Method method, int index) {
        ...
        return (isNull(types) || index >= types.length) ? null : types[index];
    }
    ...
    public static Type[] getParamTypes(Method method) {
        return isNull(method) ? null : method.getGenericParameterTypes();
    }
    ...
    public static Class<?> getParamClass(Method method, int index) {
        ...
        return (isNull(classes) || index >= classes.length) ? null : classes[index];
    }
    ...
    public static Class<?>[] getParamClasses(Method method) {
        return isNull(method) ? null : method.getParameterTypes();
    }
    ...
    public static Type getReturnType(Method method) {
        return isNull(method) ? null : method.getGenericReturnType();
    }
    ...
    public static Class<?> getReturnClass(Method method) {
        return isNull(method) ? null : method.getReturnType();
    }
    ...
    public static Type getTypeArgument(Type type, int index) {
        ...
        return (isNull(typeArguments) || index >= typeArguments.length) ? null : typeArguments[index];
    }
    ...
    public static Type[] getTypeArguments(Type type) {
        ...
        return isNull(parameterizedType) ? null : parameterizedType.getActualTypeArguments();
    }

...
import com.uneed.common.core.bean.Singleton;
import com.uneed.common.core.collection.ArrayUtil;
import com.uneed.common.core.convert.BasicType;
...
public class ClassUtil {
     ...
     *
     * <pre>
     * isSimple为false: "com.uneed.common.core.reflect.ClassUtil"
    ...
    public static String getShortClassName(String className) {
        final List<String> packages = StringUtil.split(className, StringUtil.DOT);
        if (packages.size() < 2) {
            return className;
        }
    ...
    public static boolean equals(Class<?> clazz, String className, boolean ignoreCase) {
        if (null == clazz || StringUtil.isEmpty(className)) {
            return false;
        }
        if (ignoreCase) {

...
public final class Singleton {
    ...
    public static <T> T get(Class<T> clazz, Object... params) {
        Validate.notNull(clazz, "Class must be not null !");
    ...
    public static <T> T get(String className, Object... params) {
        Validate.notEmpty(className, "Class name must be not blank !");
    ...
    public static void put(Object obj) {
        Validate.notNull(obj, "Bean object must be not null !");

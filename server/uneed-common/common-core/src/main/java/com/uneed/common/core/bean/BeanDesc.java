...
import com.uneed.common.core.collection.map.CaseInsensitiveMap;
import com.uneed.common.core.collection.map.MapUtil;
import com.uneed.common.core.lang.BooleanUtil;
import com.uneed.common.core.lang.ModifierUtil;
...
public class BeanDesc implements Serializable {
    ...
    private static final long serialVersionUID = 3918087403977231701L;
    /**
     * Bean类
     */
     ...
     * 属性Map
     */
    private Map<String, PropDesc> propMap = MapUtil.newHashMap(true);
    ...
    private boolean isMatchSetter(String methodName, String fieldName, boolean isBooeanField) {
        ...
        if (isBooeanField && fieldName.startsWith("is")) {
            // 字段是is开头
            if (methodName.equals("set" + StringUtil.substringBefore(fieldName, "is"))// isName -》 setName
    ...
    public static class PropDesc {
        ...
        private Class<?> findPropClass(Method getter, Method setter) {
            ...
            if (null == type && null != setter) {
                type = TypeUtil.getParamClass(setter);
            }
            return type;
        }
        //------------------------------------------------------------------------------------ Private method end

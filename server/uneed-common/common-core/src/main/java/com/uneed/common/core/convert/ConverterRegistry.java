...
import com.uneed.common.core.convert.impl.*;
import com.uneed.common.core.exception.ConvertException;
 ...
 * </p>
 * <p>
 * 在此类中，存放着默认转换器和自定义转换器，默认转换器是common-core中预定义的一些转换器，自定义转换器存放用户自定的转换器。
 * </p>

...
import com.uneed.common.core.bean.closure.BeanPropertyChangeClosure;
import com.uneed.common.core.bean.predicate.BeanPredicateUtil;
import com.uneed.common.core.collection.map.MapUtil;
import com.uneed.common.core.convert.ConverterRegistry;
import com.uneed.common.core.exception.UtilException;
import com.uneed.common.core.lang.CharUtil;
...
import com.uneed.common.core.reflect.TypeUtil;
...
public final class CollectionUtil {
    ...
    public static boolean isEmpty(Iterator<?> iterator) {
        return isNull(iterator) || !iterator.hasNext();
    }
    ...
    public static boolean isEmpty(Enumeration<?> enumeration) {
        return isNull(enumeration) || !enumeration.hasMoreElements();
    }
    ...
    public static <T> Collection<T> addAll(Collection<T> collection, Object value, Type elementType) {
        ...
        if (value instanceof Iterator) {
            ...
            // String按照逗号分隔的列表对待
            iter = StringUtil.split(value.toString(), CharUtil.COMMA).iterator();
        } else {
            // 其它类型按照单一元素处理
    ...
    public static <E, V> E get(Iterable<E> iterable, Function<E, V> function, V value) {
        ...
        Validate.notNull(function, "function can't be null!");
        return StreamSupport.stream(iterable.spliterator(), false).filter(e -> equal(function.apply(e), value)).findFirst().orElse(null);
    }

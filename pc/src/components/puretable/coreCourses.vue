  ...
  <div>
    ...
    <puretable :tdData="tdData" :trData="trData" :row="row">
      <div name="calc" class="calc" style="text-align: right; padding: 10px 0">
        <span> Total units of passed and not-released MR courses： </span>
        <input
          type="text"
          class="iptText"
          :readonly="true"
      ...
      <div name="calc" class="calc" style="text-align: right; padding: 10px 0">
        <span> Total units of in-process MR courses： </span>
        <input
          type="text"
          class="iptText"
          :readonly="true"
...
export default {
  ...
  watch: {
    txData: {
      ...
      immediate: true,
      handler(val) {
        this.textData = val.filter((item) => item.categoryCode === 'Major Required Courses');
      },
    },
  },
  methods: {
